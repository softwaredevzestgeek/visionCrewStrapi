...
export interface ApiCaseStudieCardCaseStudieCard extends Schema.SingleType {
  ...
  info: {
    singularName: 'case-studie-card';
    pluralName: 'case-studie-cards';
    displayName: 'case_studie_Card';
    description: '';
  };
  options: {
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    Brands: Attribute.Component<'collaborations.brands', true>;
...
export interface ApiTechStackTechStack extends Schema.CollectionType {
  ...
  attributes: {
    techName: Attribute.String;
    tech_Icon: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
